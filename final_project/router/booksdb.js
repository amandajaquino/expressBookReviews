let books = [
      { isbn: 1, author: "Chinua Achebe", title: "Things Fall Apart", reviews: { 1: "Great book!", 2: "I loved it!" } },
      { isbn: 2, author: "Hans Christian Andersen", title: "Fairy tales", reviews: { 3: "Classic stories!" } },
      { isbn: 3, author: "Dante Alighieri", title: "The Divine Comedy", reviews: { 4: "A masterpiece!" } },
